...
const faqs = [
  { q: "هل أحتاج إلى أجهزة خاصة لتشغيل النظام؟", a: "لا، نُقطة يعمل على جميع الأجهزة: الكمبيوتر، الجوال، التابلت، وأجهزة الكاشير الذكية. كل ما تحتاجه هو متصفح أو تحميل التطبيق." },
  { q: "هل النظام متوافق مع متطلبات هيئة الزكاة والضريبة؟", a: "نعم، نُقطة يدعم الفوترة الإلكترونية بالكامل (المرحلة الأولى والثانية) ومتوافق مع جميع متطلبات الجهات الرسمية." },
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            إجابات على الأسئلة الأكثر شيوعاً حول منصة نُقطة.
          </p>
        </div>
